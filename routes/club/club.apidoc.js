...
/**
 * @api {delete} /club/photo/:club_id 단체 사진 삭제
 * @apiName DeleteClubPhoto
 * @apiGroup Club
 *
 * @apiHeader {String} Authorization bearer token
 * @apiHeaderExample Request-Example:
 ...
 *     {
 *        "club_update": 0000-00-00T00:00:00.000Z,
 *        "club_photo": "images/upload/club/1/visual-123123.png"
 *     }
 *
 * @apiError BadRequest 잘못된 요청
 * @apiError Unauthorized 인증 만료 혹은 잘못된 인증으로 요청
 ...
 *     {
 *        "club_update": 0000-00-00T00:00:00.000Z,
 *        "club_photo": "images/upload/club/1/visual-123123.png,images/upload/club/1/visual-123123.png,images/upload/club/1/visual-123123.png"
 *     }
 *
 * @apiError BadRequest 잘못된 요청
 * @apiError Unauthorized 인증 만료 혹은 잘못된 인증으로 요청
